...
S1: SELECTION (SEL for short), customer presses a button linked to their beverage of preference, credit = 0

S2: CREDIT, machine has credit ≠ 0, yet credit < price

S3: BEVERAGE (BEV for short), machine has credit >= price, releases chosen beverage
